...
public class SignupThree extends JFrame implements ActionListener {
    ...
    SignupThree(String formno){
        ...
        r3.setBounds(100,140,250,20);
        add(r3);
        
        r4 = new JRadioButton("Recurring Deposit Account");
        r4.setFont(new Font("Raleway",Font.BOLD,16));
        r4.setBackground(Color.WHITE);
        r4.setBounds(350,140,250,20);
        add(r4);
        ...
        JLabel carddetail  = new JLabel("Your 16th digit card number");
        carddetail.setFont(new Font("Raleway",Font.BOLD,12));
        carddetail.setBounds(100,220,200,30);
        add(carddetail);
        
        
        JLabel pin  = new JLabel("PIN:");
        pin.setFont(new Font("Raleway",Font.BOLD,22));
        pin.setBounds(100,270,300,30);
        add(pin);
        
        JLabel pnumber  = new JLabel("XXXX");
        pnumber.setFont(new Font("Raleway",Font.BOLD,22));
        pnumber.setBounds(330,270,200,30);
        add(pnumber);
        
        JLabel pindetail  = new JLabel("Your 4th digit Password");
        pindetail.setFont(new Font("Raleway",Font.BOLD,12));
        pindetail.setBounds(100,290,200,30);
        add(pindetail);
        ...
        c1.setBounds(350,400,200,30);
        add(c1);
        
        c2  = new JCheckBox("Internet Banking");
        c2.setBackground(Color.WHITE);
        c2.setFont(new Font("Raleway",Font.BOLD,16));
        c2.setBounds(100,400,200,30);
        add(c2);
        ...
        c7 = new JCheckBox("I here by declares that aboove entered details are correct to the best of my knowledge  ");
        ...
        submit.setBounds(200,590,100,30);
